...
#pragma warning restore 414
        ...
        void FixedUpdate()
        {
            ...
            // _rb.AddForceAtPosition(Vector3.up * Vector3.Dot(Vector3.up, -velocityRelativeToWater), forcePosition, ForceMode.Acceleration);
            // _rb.AddForceAtPosition(transform.right * Vector3.Dot(transform.right, -velocityRelativeToWater), forcePosition, ForceMode.Acceleration);
            // _rb.AddForceAtPosition(transform.forward * Vector3.Dot(transform.forward, -velocityRelativeToWater), forcePosition, ForceMode.Acceleration);
